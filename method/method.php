...
<head>
  <?php get_header(); ?>
  <title>トレーニングメソッド | ジムテンプレート3</title>
</head>
    ...
    <main id="main-contents" class="c-method">
      ...
      <section class="c-topview">
        <div class="c-topview__img">
          <img class="view-sp" src="<?php echo get_template_directory_uri(); ?>/images/home/shoulder_1.jpg" alt="">
          <img class="view-pc" src="<?php echo get_template_directory_uri(); ?>/images/home/shoulder_1.jpg" alt="">
        </div>
      </section>
      <!-- /.c-topview -->
