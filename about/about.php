...
<head>
  <?php get_header(); ?>
  <title>RivRoundについて | ジムテンプレート3</title>
</head>
    ...
    <main id="main-contents" class="c-about">
      ...
      <section class="c-topview">
        <div class="c-topview__img">
          ...
          <img class="view-pc" src="<?php echo get_template_directory_uri(); ?>/images/home/shoose_1.jpg" alt="">
        </div>
      </section>
      <!-- /.c-topview -->
          ...
          <section id="flow02" class="c-flow-item">
            <div class="c-container">
              ...
              <div class="item-wrap">
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">
                    初めてお越しいただいた際は、状態測定、お客様のお悩みや目標体重や体脂肪、ウエスト、いつまでに痩せたいのかを明確に決定します。
                    カウンセリングでは、リバウンド経験の過去や飽き性などお客様に合わせたプログラムを作成出来ます。</p>
                </div>
              </div>
            </div>
          </section>
